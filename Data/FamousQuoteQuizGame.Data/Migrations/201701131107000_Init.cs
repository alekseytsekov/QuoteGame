namespace FamousQuoteQuizGame.Data.Migrations
{
    ...
    public partial class Init : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            this.DropForeignKey("dbo.Quotes", "AuthorId", "dbo.Authors");
            ...
            this.DropIndex("dbo.Quotes", new[] { "IsDeleted" });
            this.DropIndex("dbo.Quotes", new[] { "AuthorId" });
            this.DropIndex("dbo.Authors", new[] { "IsDeleted" });
